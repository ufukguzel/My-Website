...
export const ProjectList: Project[] = [
  ...
  {
    title: "Hastane Randevu Sistemi (Hospital Appointment System)",
    description: "It is a hospital appointment system developed with ASP.NET Core and Entity Framework. It allows you to make an appointment with the doctor, view your appointments, and cancel your appointments.",
